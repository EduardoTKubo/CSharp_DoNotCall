	...
	update ATU_PROCON set obs = 'ddd invalido' where obs is null and  ddd not in ( select ddd from UFBR where uf = 'CE' group by ddd )
	...
	insert into DoNotCall_CE ( ddd ,telefone ,telbase ,data ) 
