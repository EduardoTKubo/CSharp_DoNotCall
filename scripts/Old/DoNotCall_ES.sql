	...
	update ATU_PROCON set obs = 'ddd invalido' where obs is null and  ddd not in ( select ddd from UFBR where uf = 'ES' group by ddd )
	...
	insert into DoNotCall_ES ( ddd ,telefone ,telbase ,data ) 
