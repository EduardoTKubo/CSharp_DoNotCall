	...
	use procon
		select ddd from UFBR where uf = 'PB' group by ddd 
	...
	-- marcando os fones com tamanho < 7 e > 11
	...
	select * from ATU_PROCON where obs is null
	...
	update ATU_PROCON set obs = 'ddd invalido' where obs is null and  ddd not in ( select ddd from UFBR where uf = 'PB' group by ddd )
	...
	insert into DoNotCall_PB ( ddd ,telefone ,telbase ,data ) 
