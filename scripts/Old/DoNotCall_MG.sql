	...
	update ATU_PROCON set obs = 'ddd invalido' where obs is null and  ddd not in ( select ddd from UFBR where uf = 'MG' group by ddd )
	...
	insert into DoNotCall_MG ( ddd ,telefone ,telbase ,data ) 
